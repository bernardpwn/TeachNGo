...
# API yang berfungsi untuk melakukan update profile yang menerima input seperti user id yang ingin diupdate beserta beberapa detail lainnya yang ingin diupdate juga.
    ...
    if(isset($_POST['userid']) && isset($_POST['name']) && isset($_POST['password']) && isset($_POST['phone']) && isset($_POST['photo']) && isset($_POST['dob']) && isset($_POST['gender'])){
    ...
    else if(isset($_POST['userid']) && isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['photo']) && isset($_POST['dob']) && isset($_POST['gender'])){
		$userid=$_POST['userid'];
        $name=$_POST['name'];
        $phone=$_POST['phone'];
        $photo=$_POST['photo'];
		...
		$q=mysqli_query($conn,"UPDATE User SET User_Name = '$name', User_Phone = '$phone', User_Photo = '$photo', User_DOB = '$dob', User_Gender = '$gender' WHERE User_Id=$userid");
